    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <!-- Add icons to the links using the .nav-icon class
          ...
          <li class="nav-item has-treeview {{(request()->routeIs('jenis-barang.index', 'barang.index', 'UOM.index')) ? 'menu-open' : '' }}">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                <a href="{{ route('jenis-barang.index') }}" class="nav-link {{(request()->routeIs('jenis-barang.index')) ? 'active' : '' }}">
                    <i class="fas fa-circle nav-icon"></i>
                    <p>Jenis Barang</p>
                  </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('UOM.index') }}" class="nav-link {{(request()->routeIs('UOM.index')) ? 'active' : '' }}">
                        <i class="fas fa-circle nav-icon"></i>
                        <p>Satuan Barang</p>
                      </a>
                    </li>
